...
class VideoWorker(QObject):
    ...
    def __init__(self, source_type="camera", video_path=None, params=None,
                 ...
                 target_fps=30, 
                 session_save_path="captures", # <<< ADDED
                 session_timestamp=""): # <<< ADDED
        super().__init__()
        self.running = True
        self.paused = False
        ...
        # <<< ADDED: Session management variables
    ...
    def run(self):
        ...
        try:
            ...
            while self.running:
                ...
                if pest_count > 0:
                    ...
                    if current_time - self.last_event_time > self.event_cooldown_seconds:
                        ...
                        # <<< ADDED: Log detection event for summary
                        ...
                        if self.auto_save_on_detect:
                            ...
                            # <<< MODIFIED: Use session save path
                        ...
                        if self.play_sound_on_detect and winsound:
                            try:
            ...
            if cap is not None:
                cap.release()
            # <<< ADDED: Write summary file on exit
            self.write_summary_file()
            print("Video thread stopped.")

    # <<< ADDED: New method to write summary text file
...
class MainWindow(QMainWindow):
    ...
    def start_video_thread(self, source_type: str, video_path: str | None):
        ...
        # <<< ADDED: Create a new session folder for each run
        ...
        self.video_worker = VideoWorker(
            ...
            session_save_path=session_save_path, # <<< ADDED
            session_timestamp=session_timestamp, # <<< ADDED
        )
    ...
    def create_controls_panel(self):
        ...
        # Checkboxes for auto-save and sound alerts
    ...
    def set_stylesheet(self):
        self.setStyleSheet("""
            ...
            /* <<< MODIFIED: Added styles for QCheckBox to make it visible */
            QCheckBox { 
                font-size: 14px; 
                spacing: 5px; 
                color: #E0E0E0; /* Set text color to be light */
            }
            QCheckBox::indicator {
