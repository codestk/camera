            ...
            while self.running:
                ...
                if is_detecting_now:
                    ...
                    if current_time - self.last_event_time > self.event_cooldown_seconds:
                        ...
                        # Play sound each cooldown event if enabled
                        if self.play_sound_on_detect:
                            if winsound:
                                try:
                                    winsound.PlaySound("SystemExclamation", winsound.SND_ALIAS | winsound.SND_ASYNC)
                                except Exception as e:
                                    print(f"[ERROR] winsound.PlaySound failed: {e}")
                            else:
                                print('\a', flush=True)
...
class MainWindow(QMainWindow):
    ...
    def start_video_thread(self, source_type: str, video_path: str | None):
        ...
        # Initialize worker flags from current checkboxes
    ...
    def create_controls_panel(self):
        ...
        # NEW: Test sound button
        self.btn_test_sound = QPushButton("ทดสอบเสียง")
    ...
    def test_sound(self):
        if winsound:
            try:
                winsound.PlaySound("SystemExclamation", winsound.SND_ALIAS | winsound.SND_ASYNC)
                print("[SOUND] Test sound played (SystemExclamation).")
            except Exception as e:
